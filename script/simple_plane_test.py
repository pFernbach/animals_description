...
# denomK = 0 !! TEST
# UP
#q11 = [2, 1.1, 5.5, 0, 0, 0, 1, math.sqrt(1-0.8), 0, math.sqrt(0.8), 0]; q22 = [3.5, 0.5, 3.1, 0, 0, 0, 1, 0, 0, 1, 0] # theta != Pi/2
#q11 = [2, 1.1, 5.5, 0, 0, 0, 1, -math.sqrt(1-0.8), 0, math.sqrt(0.8), 0]; q22 = [1.5, 0.5, 3.1, 0, 0, 0, 1, 0, 0, 1, 0] # theta != Pi/2 # PB !!
#q11 = [2, 1.1, 5.5, 0, 0, 0, 1, 0, -math.sqrt(1-0.8), math.sqrt(0.8), 0]; q22 = [2, 0.5, 3.1, 0, 0, 0, 1, 0, 0, 1, 0] # theta = -Pi/2 # PB !!
#q11 = [2, 1.1, 5.5, 0, 0, 0, 1, 0, math.sqrt(1-0.8), math.sqrt(0.8), 0]; q22 = [2, 2.5, 3.1, 0, 0, 0, 1, 0, 0, 1, 0] # theta = Pi/2
# DOWN: all OK with the 2 absolute values
#q11 = [2, 1.1, 5.5, 0, 0, 0, 1, math.sqrt(1-0.8), 0, -math.sqrt(0.8), 0]; q22 = [2.3, 0.9, 3.1, 0, 0, 0, 1, 0, 0, 1, 0] # theta != Pi/2 # PB !!
#q11 = [2, 1.1, 5.5, 0, 0, 0, 1, -math.sqrt(1-0.8), 0, -math.sqrt(0.8), 0]; q22 = [1.8, 0.8, 3.1, 0, 0, 0, 1, 0, 0, 1, 0] # theta != Pi/2
#q11 = [2, 1.1, 5.5, 0, 0, 0, 1, 0, -math.sqrt(1-0.8), -math.sqrt(0.8), 0]; q22 = [2, 0.9, 3.1, 0, 0, 0, 1, 0, 0, 1, 0] # theta = -Pi/2
#q11 = [2, 1.1, 5.5, 0, 0, 0, 1, 0, math.sqrt(1-0.8), -math.sqrt(0.8), 0]; q22 = [2, 1.3, 3.1, 0, 0, 0, 1, 0, 0, 1, 0] # theta = Pi/2 solved with |W|
